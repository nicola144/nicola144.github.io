...
<p>
dio proco **Filtering**: The target distributions are of the form: $$p\left(\mathbf{s}_{t} | \mathbf{v}_{1: t}\right), \quad t=1, \ldots, T$$. This represents what we have learnt about the system's state at time $$t$$, after observations up to $$t$$.
