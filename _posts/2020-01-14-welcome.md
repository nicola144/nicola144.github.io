...
$$
    \mathbf{x}_t &\sim {\color{dred}{f}}(\mathbf{x}_t \mid \mathbf{x}_{1:t-1}, \mathbf{y}_{1:t-1}) 
    \mathbf{y}_t &\sim {\color{dgreen}g}(\mathbf{y}_t \mid \mathbf{x}_{1:t}, \mathbf{y}_{1:t-1})   \qquad t=1 \dots T
$$
