...
<figure>
<img src="../images/hmm.png" width="530" height="250"/>
<figcaption>Fig.1 - State space model used in this blogpost. Shaded nodes denote observed random variables.</figcaption>
</figure>
...
$$
p\left(\mathbf{s}_{t} | \mathbf{v}_{1:t}\right) = \frac{ p \left( \mathbf{v}_{t} \mid \mathbf{s}_{t}, \mathbf{v}_{1:t-1} \right ) p\left( \mathbf{s}_{t} \mid \mathbf{v}_{1:t-1} \right ) }{Z} = \frac{  \color{green}{g}\left( \mathbf{v}_{t} \mid \mathbf{s}_{t} \right ) p\left( \mathbf{s}_{t} \mid \mathbf{v}_{1:t-1} \right ) }{Z}
$$
