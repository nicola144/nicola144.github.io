...
$$\begin{equation}\begin{aligned}
w_t &= w_{t-1}(\mathbf{s}_{1:t-1}) \cdot \frac{\gamma_{t}(\mathbf{s}_{1:t})}{\gamma_{t-1}(\mathbf{s}_{1:t-1}) q_{t}(\mathbf{s}_{t}\mid \mathbf{s}_{1:t-1})} \\
