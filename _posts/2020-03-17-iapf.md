...
2. [Particle Filtering](#pf)
    1. [Basics](#basics)
        1.[Choice of proposal and variance of importance weights](#isproposal)
...
3. [Propagating particles by incoporating the current measurement](#apf)
    1. [The effect of the locally optimal proposal](#optimalproposal)
...
![hhm]({{ '/assets/images/hmm2.png' | relative_url }})
...
![pf]({{ '/assets/images/pf.png' | relative_url }})
...
Notice that by setting the proposal to the (approximate) predictive distribution, $$\color{#FF8000}{\Psi}_t(\mathbf{s}_t) := p(\mathbf{s}_{t} \mid \mathbf{v}_{1:t-1}) \approx \sum_{i=1}^{M} w_{t-1}^{i} \color{blue}{f}(\mathbf{s}_t \mid \mathbf{s}_{t-1}^{i})  $$ , i.e. setting $$ \color{#FF8000}{\lambda}_{t}^{m} = w_{t-1}^{m} $$ then we are trying to match the right term of the numerator. This results in low discrepancy between denominator and numerator, *if* we had observations that are little informative, and recovers the BPF. However, if the likelihood is high then this is clearly a bad choice. This can be seen by plugging the likelihood into the sum that composes the predictive distribution. Some kernels could be severely amplified with respect to others, thereby making the numerator very different to the proposal. The APF tries to improve on BPF *by trying to match the whole numerator with the proposal, and not just part of it*. It does with a different choice of $$ \color{#FF8000}{\lambda}_{t}^{m} $$ in a very natural way. The IS numerator $$  $$
...
\draw [white!20!black,dashed,thick] plot [smooth, tension=2] coordinates { (1.3cm,0cm) (11.5cm,0cm)};
\draw [white!20!black,dashed,thick] plot [smooth, tension=2] coordinates { (1.3cm,2.7cm) (11.5cm,2.7cm)};
\draw [white!20!black,thick] plot [smooth, tension=2] coordinates { (0.7cm,4.5cm) (12.1cm,4.5cm)};
\draw [white!20!black,dashed,thick] plot [smooth, tension=2] coordinates { (1.3cm,5.6cm) (11.5cm,5.6cm)};
\draw [white!20!black,thick] plot [smooth, tension=2] coordinates { (0.7cm,-1.1cm) (12.1cm,-1.1cm)};

\draw[->]  [black] (3cm,5.6cm) -- (3cm,4.5cm);
\draw[->]  [black] (5.3cm,5.6cm) --(5.3cm,4.5cm);
\draw[->]  [black] (6.7cm,5.6cm) --(6.7cm,4.5cm);
\draw[->]  [black] (7.6cm,5.6cm) --(7.6cm,4.5cm);
\draw[->]  [black] (9.8cm,5.6cm) --(9.8cm,4.5cm);

\draw [very thick,red!50!black,fill=red!50!black] (2cm,5.6cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (3cm,5.6cm) circle (0.4cm);
\draw [very thick,red!50!black,fill=red!50!black] (4cm,5.6cm) circle (0.15cm);
\draw [very thick,red!50!black,fill=red!50!black] (4.4cm,5.6cm) circle (0.05cm);
\draw [very thick,red!50!black,fill=red!50!black] (4.9cm,5.6cm) circle (0.07cm);
\draw [very thick,red!50!black,fill=red!50!black] (5.3cm,5.6cm) circle (0.13cm);
\draw [very thick,red!50!black,fill=red!50!black] (6.7cm,5.6cm) circle (0.2cm);
\draw [very thick,red!50!black,fill=red!50!black] (7.2cm,5.6cm) circle (0.05cm);
\draw [very thick,red!50!black,fill=red!50!black] (7.6cm,5.6cm) circle (0.17cm);
\draw [very thick,red!50!black,fill=red!50!black] (8.5cm,5.6cm) circle (0.06cm);
\draw [very thick,red!50!black,fill=red!50!black] (9.1cm,5.6cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (9.8cm,5.6cm) circle (0.3cm);


\draw[->]  [black] (3cm,4.5cm) -- (2.1cm,2.7cm);
\draw[->]  [black] (3cm,4.5cm) --(2.6cm,2.7cm);
\draw[->]  [black] (3cm,4.5cm) --(3.3cm,2.7cm);
\draw[->]  [black] (3cm,4.5cm) --(3.8cm,2.7cm);
\draw[->]  [black] (3cm,4.5cm) --(4.2cm,2.7cm);
\draw[->]  [black] (5.3cm,4.5cm) --(5.5cm,2.7cm);
\draw[->]  [black] (6.7cm,4.5cm) --(6.5cm,2.7cm);
\draw[->]  [black] (6.7cm,4.5cm) --(7cm,2.7cm);
\draw[->]  [black] (7.6cm,4.5cm) --(8cm,2.7cm);
\draw[->]  [black] (9.8cm,4.5cm) --(8.9cm,2.7cm);
\draw[->]  [black] (9.8cm,4.5cm) --(9.5cm,2.7cm);
\draw[->]  [black] (9.8cm,4.5cm) --(10.1cm,2.7cm);

\draw [very thick,red!50!black,fill=red!50!black] (3cm,4.5cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (5.3cm,4.5cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (6.7cm,4.5cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (7.6cm,4.5cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (9.8cm,4.5cm) circle (0.1cm);

\draw [black] plot [smooth] coordinates { (1.7cm,1.1cm) (2.5cm,1.8cm) (4cm,1.2cm) (5cm,1.6cm)  (6cm,1.1cm)  (7cm,0.9cm)  (8cm,1.2cm)  (9cm,2.1cm)(11cm,0.9cm)};

\draw [black] plot [smooth, tension=2] coordinates { (1.7cm,0.8cm) (11cm,0.8cm)};

\fill[white!80!black] plot[smooth] coordinates { (1.7cm,1.1cm) (2.5cm,1.8cm) (4cm,1.2cm) (5cm,1.6cm)  (6cm,1.1cm)  (7cm,0.9cm)  (8cm,1.2cm)  (9cm,2.1cm)(11cm,0.9cm)} -- (11cm,0.8cm) -- (1.7cm,0.8cm);
\draw[->]  [black] (2.1cm,2.7cm) -- (2.1cm,0cm);
\draw[->]  [black] (2.6cm,2.7cm) --(2.6cm,0cm);
\draw[->]  [black] (3.3cm,2.7cm) --(3.3cm,0cm);
\draw[->]  [black] (3.8cm,2.7cm) --(3.8cm,0cm);
\draw[->]  [black] (4.2cm,2.7cm) --(4.2cm,0cm);
\draw[->]  [black] (5.5cm,2.7cm) --(5.5cm,0cm);
\draw[->]  [black] (6.5cm,2.7cm) --(6.5cm,0cm);
\draw[->]  [black] (7cm,2.7cm) --(7cm,0cm);
\draw[->]  [black] (8cm,2.7cm) --(8cm,0cm);
\draw[->]  [black] (8.9cm,2.7cm) --(8.9cm,0cm);
\draw[->]  [black] (9.5cm,2.7cm) --(9.5cm,0cm);
\draw[->]  [black] (10.1cm,2.7cm) --(10.1cm,0cm);

\draw [very thick,red!50!black,fill=red!50!black] (2.1cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (2.6cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (3.3cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (3.8cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (4.2cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (5.5cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (6.5cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (7cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (8cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (8.9cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (9.5cm,2.7cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (10.1cm,2.7cm) circle (0.1cm);



\draw[->]  [black] (2.6cm,0cm) --(2.6cm,-1.1cm);
\draw[->]  [black] (3.8cm,0cm) --(3.8cm,-1.1cm);
\draw[->]  [black] (5.5cm,0cm) --(5.5cm,-1.1cm);
\draw[->]  [black] (8.9cm,0cm) --(8.9cm,-1.1cm);
\draw[->]  [black] (9.5cm,0cm) --(9.5cm,-1.1cm);


\draw [very thick,red!50!black,fill=red!50!black] (2.1cm,0cm) circle (0.14cm);
\draw [very thick,red!50!black,fill=red!50!black] (2.6cm,0cm) circle (0.18cm);
\draw [very thick,red!50!black,fill=red!50!black] (3.3cm,0cm) circle (0.13cm);
\draw [very thick,red!50!black,fill=red!50!black] (3.8cm,0cm) circle (0.11cm);
\draw [very thick,red!50!black,fill=red!50!black] (4.2cm,0cm) circle (0.11cm);
\draw [very thick,red!50!black,fill=red!50!black] (5.5cm,0cm) circle (0.14cm);
\draw [very thick,red!50!black,fill=red!50!black] (6.5cm,0cm) circle (0.065cm);
\draw [very thick,red!50!black,fill=red!50!black] (7cm,0cm) circle (0.03cm);
\draw [very thick,red!50!black,fill=red!50!black] (8cm,0cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (8.9cm,0cm) circle (0.28cm);
\draw [very thick,red!50!black,fill=red!50!black] (9.5cm,0cm) circle (0.22cm);
\draw [very thick,red!50!black,fill=red!50!black] (10.1cm,0cm) circle (0.13cm);


\draw [very thick,red!50!black,fill=red!50!black] (2.6cm,-1.1cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (3.8cm,-1.1cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (5.5cm,-1.1cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (8.9cm,-1.1cm) circle (0.1cm);
\draw [very thick,red!50!black,fill=red!50!black] (9.5cm,-1.1cm) circle (0.1cm);

\draw [very thick] (11.4cm,5.3cm) node[below] {\Large $t-1$};
\draw [very thick] (11.4cm,2cm) node[below] {\Large$t$};

\draw [very thick] (0.9cm,5.3cm) node[below] {\scriptsize 3. Resampling};
\draw [very thick] (3.2cm,5.1cm) node[below] {\scriptsize x5};
\draw [very thick] (5.5cm,5.1cm) node[below] {\scriptsize x1};
\draw [very thick] (6.9cm,5.1cm) node[below] {\scriptsize x2};
\draw [very thick] (7.8cm,5.1cm) node[below] {\scriptsize x1};
\draw [very thick] (10cm,5.1cm) node[below] {\scriptsize x3};
\draw [very thick] (0.8cm,4.3cm) node[below] {\scriptsize 1. Propagate};
\draw [very thick] (0.8cm,4cm) node[below] {\scriptsize  (predict)};
\draw [very thick] (1cm,3.5cm) node[below] {\scriptsize $x_t^{(m)} \sim \cblue{p(x_t|\tilde{x}_{t-1}^{(m)})}$};

\draw [very thick] (1cm,2.3cm) node[below] {\scriptsize 2. Weights calc.};
\draw [very thick] (1cm,2cm) node[below] {\scriptsize (update)};
\draw [very thick] (1cm,0.8cm) node[below] {\scriptsize  $w_t^{(m)} \propto \cgreen{p(y_t| x_t^{(m)})}$};

\draw [very thick] (0.9cm,-0.3cm) node[below] {\scriptsize 3. Resampling};

\draw [very thick] (2.8cm,-0.5cm) node[below] {\scriptsize x2};
\draw [very thick] (5.7cm,-0.5cm) node[below] {\scriptsize x1};
\draw [very thick] (4.0cm,-0.5cm) node[below] {\scriptsize x1};
\draw [very thick] (9.1cm,-0.5cm) node[below] {\scriptsize x4};
\draw [very thick] (9.7cm,-0.5cm) node[below] {\scriptsize x4};

\draw [very thick] (1cm,-0.6cm) node[below] {\scriptsize  $\tilde \x_t^{(m)}\sim \cgranate{\sum_{j=1}^M w_t^{(j)} \delta(\x-\x_t^{(j)})}$};
\end{tikzpicture}
</script>
