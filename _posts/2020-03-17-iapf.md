...
4. **Weight update**: Compute weights:
    $$\tilde{w}_{t} =  \frac{\color{green}{g}(\mathbf{v}_t \mid \mathbf{s}_{t}^{m})}{\color{green}{g}(\mathbf{v}_{t} \mid ^{r \hspace{-1pt}}\boldsymbol{\mu}_{t}^{m} )}$$
...
At time $$t=1$$: draw M i.i.d. samples from the "proposal" $$ \color{blue}{f}(\mathbf{s}_1) $$ *and* set $$\color{#FF8000}{\lambda}_{1}^{m} = 1/M$$
...
$$ \color{#FF8000}{\lambda}_{t}^{m} = \color{green}{g}(\mathbf{v}_{t} \mid \boldsymbol{\mu}_{t-1}^{m}) \cdot w_{t-1}^{m} $$ 
...
\hline
\lambda_{t}^{m} & w_{t}^{m} & \color{green}{g}(\mathbf{v}_{t} \mid \boldsymbol{\mu}_{t-1}^{m}) \cdot w_{t-1}^{m} & \frac{\color{green}{g}(\mathbf{v}_{t} \mid \boldsymbol{\mu}_{t-1}^{m}) \sum_{\color{red}{i}=1}^{M} w_{t-1}^{\color{red}{i}} \color{blue}{f}(\boldsymbol{\mu}_{t-1}^{m} \mid \mathbf{s}_{t-1}^{\color{red}{i}})}{\sum_{\color{red}{i}=1}^{M} \color{#FF8000}{\lambda}_{t}^{i} \color{blue}{f}(\mathbf{s}_{t}^{m} \mid \mathbf{s}_{t-1}^{\color{red}{i}})} \\
w_{t}^{m} & \color{green}{g}(\mathbf{v}_t \mid \mathbf{s}_{t}^{m}) & \frac{\color{green}{g}(\mathbf{v}_t \mid \mathbf{s}_{t}^{m}) }{    \color{green}{g}( \mathbf{v}_t \mid ^{r \hspace{-1pt}}\boldsymbol{\mu}_{t}^{m}) } & \frac{\color{green}{g}(\mathbf{v}_t \mid \mathbf{s}_{t}^{m}) \sum_{\color{red}{i}=1}^{M} w_{t-1}^{\color{red}{i}} \color{blue}{f}( \boldsymbol{\mu}_{t-1}^{m} \mid \mathbf{s}_{t-1}^{m}) }{ \sum_{\color{red}{i}=1}^{M} \color{blue}{f}(\boldsymbol{\mu}_{t-1}^{m} \mid \mathbf{s}_{t-1}^{\color{red}{i}} )}
\end{array}
$$
