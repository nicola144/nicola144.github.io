...
$$\begin{equation}\begin{aligned}
p(x_{1:t} , y_{\color{red}{t+1}}) &= \int p(x_{1:t+1} , y_{1:t+1}) \mathrm{d} x_t+1 \\
&= \int p(x_{1:t} , y_{1:t}) \cdot {\color{blue}{f}}(x_{t+1} \mid x_{t}) \cdot {\color{green}{g}}(y_{t+1} \mid x_{t+1}) \mathrm{d} x_t \\
&=  p(x_{1:t+1} , y_{1:t+1}) \int {\color{blue}{f}}(x_{t+1} \mid x_{t}) \cdot {\color{green}{g}}(y_{t+1} \mid x_{t+1}) \mathrm{d} x_{t+1} \\
&=  p(x_{1:t+1} , y_{1:t+1}) \cdot \underbrace{p(y_{t+1} \mid x_{t})}_{"predictive~likelihood"}
