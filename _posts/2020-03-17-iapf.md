...
Monte Carlo approximations of this kind are very appealing since unbiased and consistent, and it is easy to show that the variance of the estimate is $$ \mathcal{O}(n^{-2})$$ *regardless* of the dimensionality of the vector $$\mathbf{x}$$.
