...
&= \frac{\color{green}{g}(\mathbf{v}_{t}}{p(\mathbf{v}_{t} \mid \mathbf{v}_{1:t-1})} \int p(\mathbf{s}_{1:t-1} \mid \mathbf{v}_{1:t-1}) \color{blue}{f}(\mathbf{s}_{t} \mid \mathbf{s}_{t-1}) \mathrm{d} \mathbf{s}_{1:t-1} \\
&= \frac{\color{green}{g}(\mathbf{v}_{t}}{p(\mathbf{v}_{t} \mid \mathbf{v}_{1:t-1})} \int p(\mathbf{s}_{1:t} \mid \mathbf{v}_{1:t-1}) \mathrm{d} \mathbf{s}_{1:t-1} \\
&= \frac{p(\mathbf{s}_{t} \mid \mathbf{v}_{1:t-1}) }{wat}
