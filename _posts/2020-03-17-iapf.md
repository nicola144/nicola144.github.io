...
$$\begin{equation}\begin{aligned}
p(\mathbf{s}_{1:t}, \mathbf{v}{1:t}) = p(\mathbf{s}_{1:t-1}, \mathbf{v}{1:t-1}) \color{blue}{f}(\mathbf{s}_{t} \mid \mathbf{s}_{t-1}) \color{green}{g}(\mathbf{v}_{t} \mid \mathbf{s}_{t}) 
