...
In this post, I am only concerned with filtering, and will always assume that any parameters of <span style="color:blue">some transition</span> or observation densities are known in advance. 
