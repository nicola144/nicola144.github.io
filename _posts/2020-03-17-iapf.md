...
\hline
\lambda_{t}^{m} & w_{t}^{m} & \color{green}{g}(\mathbf{v}_{t} \mid \boldsymbol{\mu}_{t-1}^{m}) \cdot w_{t-1}^{m} & \frac{\color{green}{g}(\mathbf{v}_{t} \mid \mathbf{s}_{t}^{m}) \sum_{\color{red}{i}=1}^{M} w_{t-1}^{\color{red}{i}} \color{blue}{f}(\mathbf{s}_{t}^{m} \mid \mathbf{s}_{t-1}^{\color{red}{i}})}{\sum_{\color{red}{i}=1}^{M} \color{#FF8000}{\lambda}_{t}^{i} \color{blue}{f}(\mathbf{s}_{t}^{m} \mid \mathbf{s}_{t-1}^{\color{red}{i}}}) \\
w_{t}^{m} & \color{green}{g}(\mathbf{v}_t \mid \mathbf{s}_{t}^{m}) & \frac{\color{green}{g}(\mathbf{v}_t \mid \mathbf{s}_{t}^{m}) }{    \color{green}{g}( \mathbf{v}_t \mid ^{r \hspace{-1pt}}\boldsymbol{\mu}_{t}^{m}) } & -8 
\end{array}
$$
