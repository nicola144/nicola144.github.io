...
$$
\color{#FF8000}{\Psi}_t(\mathbf{s}_t) = \sum_{m=1}^{M} \lambda_{t}^{M} \color{blue}{f}(\mathbf{s}_t \mid \mathbf{s}_{t-1})
$$
...
&= \frac{\color{green}{g}(\mathbf{v}_{t} \mid \mathbf{s}_{t}^{m}) p(\mathbf{s}_{t}^{m} \mid \mathbf{v}_{1:t-1})}{\color{#FF8000}{\color{#FF8000}{\Psi}_t(\mathbf{s}_{t}^{m})} \\
&\approx \frac{\color{green}{g}(\mathbf{v}_{t} \mid \mathbf{s}_{t}^{m}) \sum_{m=1}^{M} w_{t-1}^{\color{red}{i}} \color{blue}{f}(\mathbf{s}_{t}^{\color{red}{i}} \mid \mathbf{s}_{t-1}^{\color{red}{i}})}{\color{#FF8000}{\Psi}_t(\mathbf{s}_{t}^{m})}
