...
![pf]({{ '/assets/images/pf.png | relative_url }}){: style="width: 100%;" class="center"}
...
&= \tilde{w}_{t-1}(\mathbf{s}_{1:t-1}) \cdot \frac{\cancel{f(\mathbf{s}_{t}\mid \mathbf{s}_{t-1})} \color{green}{g}(\mathbf{v}_{t} \mid \mathbf{s}_{t})}{g(\mathbf{v}_{t} \mid \boldsymbol{\mu}_{t-1}) \cancel{f(\mathbf{s}_{t}\mid \mathbf{s}_{t-1})}}
...
4. **Weight update**: Compute weights:
    $$\tilde{w}_{t} =  \frac{\color{green}{g}(\mathbf{v}_t \mid \mathbf{s}_{t}^{m})}{p(\mathbf{v}_{t} \mid \boldsymbol{\mu}_{t_{r}}^{m} )}$$
...
\hline
\lambda_{t}^{m} & w_{t}^{m} & p(\mathbf{v}_{t} \mid \boldsymbol{\mu}_{t-1}^{m}) \cdot w_{t-1}^{m} & \frac{\color{green}{g}(\mathbf{v}_{t} \mid \mathbf{s}_{t}^{m}) \sum_{\color{red}{i}=1}^{M} w_{t-1}^{\color{red}{i}} \color{blue}{f}(\mathbf{s}_{t}^{m} \mid \mathbf{s}_{t-1}^{\color{red}{i}})}{\sum_{\color{red}{i}=1}^{M} \lambda_{t}^{i} \color{blue}{f}(\mathbf{s}_{t}^{m} \mid \mathbf{s}_{t-1}^{\color{red}{i}}} \\
\RR & -1 & 189 & -8 \\
3 & -20 & 2000 & 1+10i
\end{array}
$$
