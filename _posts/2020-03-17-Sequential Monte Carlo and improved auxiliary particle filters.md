...
&= \frac{1}{N} \left [\frac{(2\pi \sigma^2)^{t/2}}{(2\pi)^t} \int  \exp \left\{ x_{1:t}^{\top} x_{1:t} -\frac{1}{2}\left [ 2 - \frac{1}{\sigma^2} \right ]\right\} \mathrm{d}x_{1:t} - 1\right] \qquad \text{as}~ x_{1:t}^{\top}x_{1:t} = \sum_{k=1}^{t} x_{k}^{2} \\
